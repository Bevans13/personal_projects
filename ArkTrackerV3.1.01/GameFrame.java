...
public class GameFrame extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getActionCommand().equals("Submit")) {
            ...
            for (int i = 0; i < 20; i++) {
                if (i<8) {
                    currentWorld.createCreature("testcreature"+i, "raptor", 'M', i, i, i, i, i, i, i, i);
                } else 
                if (i>=8&&i<14) {
                    currentWorld.createCreature("testcreature"+i, "dodo", 'M', i, i, i, i, i, i, i, i);

                } else {
                    currentWorld.createCreature("testcreature"+i, "parasaur", 'M', i, i, i, i, i, i, i, i);
        ...
        if (e.getActionCommand().equals("View")) {
            ...
            } // Being in the View actionevent causes duplicate listeners for RIP buttons causing RIP issues.
            this.requestFocus();
        }
