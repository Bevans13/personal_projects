...
public class SaveFileManager {
    ...
    public static void readSaveData(WorldPanel loadingWorld){
        try {
            ...
            FileInputStream fileIn = new FileInputStream(loadingWorld.getSaveFilePath()+".ser");
            ...
            i.printStackTrace();
            System.out.println("IOException in readSaveData()");
            return;
    ...
    public static void writeSaveDate(WorldPanel savingWorld){
        try {
            FileOutputStream fileOut = new FileOutputStream(savingWorld.getSaveFilePath()+".ser");
